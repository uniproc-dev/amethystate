...
fn test_subscribe_map_key() {
    let (_at, store) = unique_store("subscribe_map_key");
    let state = TestState::new_with(&store).unwrap();
    let arena = Arena::new();
...
fn test_arena_cleanup_drops_fields_and_unsubscribes() {
    let (_at, store) = unique_store("cleanup-test");
...
fn test_arena_remove_map_entry() {
    let (_at, store) = unique_store("remove_map_entry");
    let state = TestState::new_with(&store).unwrap();
    let arena = Arena::new();
...
fn test_arena_clear_map() {
    let (_at, store) = unique_store("clear_map");
    let state = TestState::new_with(&store).unwrap();
    let arena = Arena::new();
...
fn test_arena_remove_map_entry_fires_subscription() {
    let (_at, store) = unique_store("remove_fires_sub");
    let state = TestState::new_with(&store).unwrap();
    let arena = Arena::new();
...
fn test_arena_clear_map_fires_subscription() {
    let (_at, store) = unique_store("clear_fires_sub");
    let state = TestState::new_with(&store).unwrap();
    let arena = Arena::new();
