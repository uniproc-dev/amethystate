...
| `on_delete` | вариант | Что делать, когда ключ поля удалили. У карты речь про её уровень: `UseDefault` возвращает объявленные записи, когда уровень удалили, `Keep` оставляет так, как оставил store. |
